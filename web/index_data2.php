...
<script language="javascript">
 ...
 <div class="centercontent">
    <div class="pageheader">
        ...
        <ul class="hornav">
            <li ><a href="index_data.php">实时曲线</a></li>
            <li class="current"><a href="index_data2.php">历史曲线</a></li>
        </ul>
    </div><!--pageheader-->
    <div>
        <form name="form1" target="postTo" action="index_data2.php" method="GET" id="chaxun">
        路灯id<select type='text' name="lampid" id="sel"  onFocus="Myselect()" value="<?php echo "'$lampid'"?>"></select>
